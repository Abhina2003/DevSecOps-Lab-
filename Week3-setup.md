...
Objective
Write Terraform IaC scripts and scan them using Checkov to detect cloud misconfigurations before deployment.
...
terraform --version
Note: Kali mirror timeout hota hai apt install ke liye, isliye direct binary download kiya hashicorp releases se.
